...
# 必要なライブラリのインポート
# -----------------------------------------------
import streamlit as st                           # Webアプリ作成用ライブラリ
...
# ===============================================
with tab3:
    # データをランダムに100件抽出して地図にプロット
    st.map(df.sample(n=100), latitude="START_STATION_LATITUDE", longitude="START_STATION_LONGITUDE")
    st.write("")
